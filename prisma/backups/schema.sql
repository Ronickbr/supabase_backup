...
CREATE TABLE IF NOT EXISTS "public"."unpaused" (
    "id" bigint NOT NULL,
...
ALTER TABLE "public"."unpaused" OWNER TO "postgres";


ALTER TABLE "public"."unpaused" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."unpaused_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."unpaused"
    ADD CONSTRAINT "unpaused_pkey" PRIMARY KEY ("id");
...
GRANT ALL ON TABLE "public"."unpaused" TO "anon";
GRANT ALL ON TABLE "public"."unpaused" TO "authenticated";
GRANT ALL ON TABLE "public"."unpaused" TO "service_role";



GRANT ALL ON SEQUENCE "public"."unpaused_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."unpaused_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."unpaused_id_seq" TO "service_role";
