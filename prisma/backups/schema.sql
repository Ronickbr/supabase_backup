...
ALTER TABLE ONLY "public"."contracts"
    ADD CONSTRAINT "contracts_quote_id_fkey" FOREIGN KEY ("quote_id") REFERENCES "public"."quotes"("id") ON DELETE CASCADE;
...
CREATE POLICY "Users can delete own contracts" ON "public"."contracts" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."quotes"
...
CREATE POLICY "Users can insert own contracts" ON "public"."contracts" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."quotes"
  WHERE (("quotes"."id" = "contracts"."quote_id") AND ("quotes"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can update own contracts" ON "public"."contracts" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."quotes"
  WHERE (("quotes"."id" = "contracts"."quote_id") AND ("quotes"."user_id" = "auth"."uid"())))));
